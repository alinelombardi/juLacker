// src/components/MapaProsperidade.jsx
...
function MapaProsperidade() {
  ...
  // Cores baseadas no estilo escuro da Mentoria do Mês
  const sectionStyle = {
  ...
  // Cards com fundo translúcido para combinar com o fundo escuro
  const cardStyle = {
    display: "flex",
    alignItems: "start",
    gap: "15px",
...
//   // Estilo forçado para simetria (2 colunas ou 1 no celular)
//   const grid4Cards = {
//     display: "grid",
//     gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))",
//     gap: "20px",
...
//   // Estilo forçado para simetria (3 colunas ou 2/1 dependendo da tela)
//   const grid6Cards = {
//     display: "grid",
//     gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))",
//     gap: "20px",
...
//           style={{
//             ...textBlockStyle,
//             backgroundColor: "rgba(var(--cor-primaria-rgb), 0.05)",
//             padding: "40px",
//             borderRadius: "15px",
//             marginBottom: "60px",
//           }}
...
//           >
//             É por isso que eu criei o{" "}
//             <span style={{ color: "var(--cor-primaria)", fontWeight: "bold" }}>
//               Mapa da Prosperidade Financeira
//             </span>
//             .
//           </p>
